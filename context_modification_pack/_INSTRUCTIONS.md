...
| `_INDEX.md` | Live routing map. Hot path, aliases, cross-references. | Multi-altitude: chat / project / root. | Updated as part of every Tier 1 flush per the mandatory checklist below. |
...
1. Read `_INSTRUCTIONS.md`.
2. Read `_INDEX.md` — refresh routing.
